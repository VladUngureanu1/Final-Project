...
class BasePage(Browser):
    ...
    def check_error_message(self, selector, expected_error_message):
        error_message_web_element = WebDriverWait(self.chrome, 20).until(EC.presence_of_element_located((by, selector, expected_error_message)))
